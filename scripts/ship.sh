...
# ── ONE PUBLIC NAME: MOT Deck (U150, sample 2026-09-07) ─────────────────────────
#
...
if [[ "$_MARK_CHANGED" -eq 1 ]]; then
  ...
  #
  # ⛔ sample authorised "killall Dock" for this (2026-09-02: "Dock restart is allowed,
  ...
  # standalone app of sample's the way `killall` can. Same effect, inside the rule.
  #
...
# Both are the class that closed sample's standalone Unsloth and goose Desktop. Now:

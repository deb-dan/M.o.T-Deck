...
def main() -> int:
    ...
    # row still offered a 27B sample had deleted from the registry (its file was gone,
    ...
    if marker and "models" not in marker and seeded_before:
        ...
        # accumulated are ours to drop — measured on sample's live config, which had 21

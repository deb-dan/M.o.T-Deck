...
# sample's ask: "rescan audio models already on the computer". The classifier below is
...
# ══ RESCAN IS THE PRUNE (sample, 2026-08-29: "isn't there a way to make the apps scan?")
#

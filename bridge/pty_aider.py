...
5. **THE PROCESS OUTLIVES THE SOCKET — A DROPPED SOCKET IS NOT AN ENDED SESSION.**
   ⚠️ THIS REVERSES v1'S RULE, AND THE REASON IS THE COMPLAINT THAT PRODUCED IT (sample,
...
def attach_verdict(alive: bool, attached: bool, requested_id: str = "",
    ...
    be proven without a browser:
      ...
      · running AND another page attached  → takeover  ← sample's repro, see below
    ...
    answer whenever another page held the session, and it produced sample's screenshot
...
class PtySession:
    ...
    def attach(self, cb):
        ...
        ⚠️ AND ATTACH IS A TAKEOVER, NOT A QUEUE — sample's live repro, 2026-08-29, which

...
# v2.1 (sample ask, LM Studio reference): every row explains itself on hover. ONE source
...
# v2 (2026-08-20, sample ruling): the same saved values ALSO become the engine's launch
...
#
# v2.1 (2026-08-20, sample ask): the group is filled out with the rest of llama.cpp's

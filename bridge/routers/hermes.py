...
# SEGMENT, NOT TURN (2026-08-14h, Fable revision after sample's objection): a cap on
...
def hermes_segment_spent(now: float, started_at: float,
    ...
    that legitimately waits for sample must never be shot. `paused_total` is the sum of
    ...
    async def gen():
        ...
        try:
            ...
            while True:
                ...
                # that is WAITING FOR sample would be the worst failure of this guard.

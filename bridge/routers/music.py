...
def compose_page() -> FileResponse:
    ...
    #view-music) is untouched by this slice, on purpose: sample compares the two surfaces
...
async def music_generate(req: Request) -> JSONResponse:
    ...
    # THE LEDGER IS A WARNING, NOT A WALL (sample's ruling). The first POST gets the

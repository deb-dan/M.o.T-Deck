...
sample's ruling (2026-09-02, verbatim): *"i think we should have an option that fully quits
...
def test_the_menu_carries_both_doors():
    ...
    # 2026-09-02 (sample: the Dock hover), and test_app_identity_contract.py is what keeps

...
# owes sample, not a silent stub. Mapping: method → what the user loses.
DEGRADED = {
...
#
# WHY THIS EXISTS (sample, asked twice): the sidebar's CHATS list has NO per-item delete
...
# ⚠️ THE NAME OF *OUR* SURFACE, NOT OF GOOSE (sample's ruling, 2026-08-29). The embedded

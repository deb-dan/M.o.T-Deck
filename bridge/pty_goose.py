...
# sessions" — sample, 2026-08-29). Everything below was MEASURED against the pinned
...
# The chip grammar (sample's rule): a chip is at most SEVEN WORDS and never a sentence.
CHIP_WORDS = 7
...
def reap_orphan(root, base_env=None) -> str:
    ...
    sample's standalone goose, a matching command/path/CWD, and a legacy bare pidfile

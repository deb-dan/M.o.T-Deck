...
/* ══ THE VERDICT TOOLTIP — ONE PAYLOAD, THREE INPUT METHODS ═══════════════════
   sample's ruling (2026-08-29): the row keeps the CHIP; the sentence, the arithmetic
...
function renderMemStrip(){
  ...
  // ══ STATUS + DELTA, THE GRAMMAR sample CHOSE (2026-08-29) ═══════════════════════
...
function paintFitChips(){
  ...
  for (const row of nodes){
    ...
    // THE ROW IS THE CHIP AND NOTHING ELSE (sample, 2026-08-29). The sentence, the
...
/* THE DETAIL PANE, RESTRUCTURED (sample, 2026-08-29). It used to print four lines at

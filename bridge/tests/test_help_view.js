 ...
 *     exclusion).
 *
 *  5. ALL DESIGNS (sample's standing rule). Editorial, the three packs and studio
...
// ═════════════════════════════════════════════════════════════════════════════
console.log('\n2b. the API page is EXPLAINED, not merely mentioned (sample, 2026-09-02)');
// ═════════════════════════════════════════════════════════════════════════════
...
// ═════════════════════════════════════════════════════════════════════════════
console.log('\n6. ALL DESIGNS (sample\'s standing rule) — the mechanism, structurally');
// ═════════════════════════════════════════════════════════════════════════════
{

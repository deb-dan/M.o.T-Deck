...
# THE REGRESSION THAT PRODUCED sample'S "video-analysis is ON and I never enabled it":
...
check("VIDEO ANALYSIS specifically — the row from sample's screenshot — is never "
...
# ═════════════════════════════════════════════════════════════════════════════
# WHICH ROWS THIS LEVER GOVERNS — the platform/scope question sample's report
...
# ── sample'S EXACT REPORT, reproduced end to end ───────────────────────────────
...
sample = [row("web", True, ["web_search"]), row("terminal", True, ["terminal"]),
...
_all = hermes_preset_desired(sample, "all")
...
_off_term = hermes_toolset_plan(sample, [], ["terminal"])

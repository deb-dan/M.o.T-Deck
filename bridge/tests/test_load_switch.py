...
try:
    ...
    #
    # JOURNEY 1 — "it said FAILED while the model was answering." sample switched to
    ...
    # raw tail, so the failure sample saw was
...
#
# THE USER STORY: sample switches the runner from the 27B to Parable. Before this, the

#!/usr/bin/env python3
"""IMAGE ATTACH ON EVERY LANE — the bridge half (2026-08-28, sample's ruling).
...
w, why = ody_vision_wire_decision("sample-picked-this", "", "m1")
...
check("…but a hand-set value that merely differs from our marker is still safe",
      ody_vision_wire_decision("sample", "m0", "m1")[0] is False)

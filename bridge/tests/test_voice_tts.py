...
What is pinned here, and why each one exists:
  ...
  * tts_argv — the exact argv of both engines, verified on sample's Mac 2026-08-07.
...
try:
    ...
    # DEFAULT-VOICE FALLBACK (sample 2026-08-13): "model default" on CustomVoice ERR'd

...
async function main(){
  ...
  const grammar = [
    ...
    {seq:9, type:'file_card', path:'/Users/testuser/result.txt'},
    {seq:10, type:'guard_flag', path:'/Users/testuser/outside.txt'},
  ...
  if (!holder._guardFlags || !holder._guardFlags.has('/Users/testuser/outside.txt'))

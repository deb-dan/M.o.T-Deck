...
downloaded = audio_row("parakeet-tdt-0.6b-v3", download_dir, "download",
                       voice="sample", ref_audio="/clips/reference.wav", verified="sha256")
...
_ex2 = [
    {"id": "omni", "source": "local", "kind": "audio", "format": "tts-mlx",
     "ref_audio": "/Users/d/data/voices/sample.wav", "ref_text": "hello there",
     "voice": "af_heart"},
...
check("rescan keeps a pinned REFERENCE CLIP",
      _m2["omni"].get("ref_audio") == "/Users/d/data/voices/sample.wav")

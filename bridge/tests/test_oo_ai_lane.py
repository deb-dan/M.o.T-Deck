...
# is there — this is the sentence sample actually reads.
...
#
# sample's finding: chat in the ribbon's Chatbot, switch file, the conversation is gone.
...
#
# v1.5.31. The sixth upstream trap. sample's finding: AI → Summarization / Translation

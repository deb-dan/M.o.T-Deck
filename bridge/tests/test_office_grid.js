...
// NAVIGATION to /oo-edit that 2026-08-27c introduced, and sample's one-editor ruling
...
['script-start', 'boot-inline', 'dom-ready', 'tier1-ready', 'grid-render', 'files-ok',
 ...
 // navigation that sample's one-editor ruling deleted; the EDITOR's own beacons are
...
(function () {
  ...
  (async () => {
    ...
    /* ══ THE BUSY LATCH, AND THE SILENT-GUARD CLASS ════════════════════════════
       THE JOURNEY THIS PINS (sample, 2026-08-29, five failed clicks): the LOffice file
    ...
    await (async () => {
      ...
      said.length = 0;
      busyOn('making the PDF of “a.xlsx”', 30000);     // the shape of sample's stuck page

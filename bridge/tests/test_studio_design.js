...
}
{
  /* THE BYTE BUDGET. Editorial's page weight is the thing "untouched" has to include,
     ...
     Ceiling history (each line = a slice that consciously raised it):
       ...
       720000  the impeccable-debt slice (v1.5.24, 2026-08-28) — +14KB, and it is almost
               ...
               chip size that overrode a standing sample ruling, the full-width transcript,
       ...
       745000  v1.5.26, sample's composer + navigation wave — +23.7KB, and here is what it
               ...
               the four specificity restatements, and the two moved sample rulings — talk
       ...
       780000  the CAPABILITY-AFFORDANCE slice (2026-08-28, sample's "all paths have what
       ...
       795000  the RAM FIT ADVISOR, slice 1 (v1.5.30, sample's RAM ruling + the
       ...
       820000  THE FIT ADVISOR S2 + sample'S 2026-08-29 DESIGN REVIEW (v1.5.33) —
               ...
               what lets sample's "the long text should be when someone hovers" ruling
               ...
               the disclosure, and sample's composer polish — ⊕ / ● talk / the audio switch
       ...
       834000  THE 9+3 STRIP + THE ONE MUSIC DOOR (v1.5.49, sample's two rulings of
  ...
  /*     840000  RUNNER STATUS HONESTY (U15, 2026-08-29) — ~5.5KB, and the argument is
               ...
               The incident: sample deleted the resident 27B's weights in LM Studio; the
  ...
  /*     843000  THE COHERENCE WAVE — PIN-ALIGN (S28, 2026-08-29) — +2.7KB, and per the
               ...
               or hand-edited motdeck.yaml. sample hit that wall. What landed: `drift`
  ...
  /*     871000  THE LOCAL API ACCESS SURFACE (S32, 2026-08-29) — +24.7KB, and per the
         ...
         877000  A GREEN CARD MAY NOT CARRY A BARE FAILURE SENTENCE (U60) — +0.7KB, and
               ...
               the bridge. sample's screenshot: "Online · serving Qwen3.5-9B-Q4_0" and, on
...
console.log('6. the states another rule owns (the collision trap)');
{
  ...
  // v1.5.24: 24px → 44px. v1.5.26: 44px → 34px (sample — office.html's house strip width).
  ...
  ok(col && new RegExp('width:' + edCol[1] + 'px').test(col.body) && /padding-right:0/.test(col.body),
     ...
     + 'sample\'s 2026-08-29 review said 34 is "a bit big still")');

 ...
 * v1.5.25 · FABLE-STUDIO-DESIGN-SPEC §4, extended to /office by sample's GO.
 *
 ...
 *
 * 7. THE DELETE CONFIRM NEVER EXPIRES ON A TIMER. sample's report: "when delete is
...
// ═══════════════════════════════════════════════════════════════════════════════
console.log('9. THE DELETE CONFIRM — sample\'s report, pinned');
// ═══════════════════════════════════════════════════════════════════════════════
...
// schedules one, this section fails rather than passing quietly.
{
  ...
  try {
    // A BUSY CLICK SPEAKS — the silent-guard ban (v1.5.65, sample's five dead clicks).

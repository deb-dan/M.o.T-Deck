 ...
 *
 *  6. ALL DESIGNS (sample's standing rule), verified structurally: the API block's own
...
// (a) THE ORDINARY DAY — the screen sample looks at. ONE sentence: the honest split.
...
ok(/Paste this into the app's provider form/.test(shown),
   '…and names what to do with it (sample\u2019s brief, verbatim)');

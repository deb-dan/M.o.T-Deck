...
// sample actually typed — are the first pixels a downscaler throws away.
//
...
//             rather than a rule. sample's brief authorises exactly this fallback and asks
...
func render(_ px: Int) -> NSBitmapImageRep {
    ...
    // GOLD PERIODS. They are the part of "M.O.T" sample typed and the part a plain
